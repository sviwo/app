...
class SvgProvider extends ImageProvider<SvgImageKey> {
  ...
  @override
  ImageStreamCompleter loadBuffer(SvgImageKey key, DecoderBufferCallback decode) {
  ...
  static Future<ImageInfo> _loadAsync(SvgImageKey key) async {
    ...
    // final pictureInfo = await SvgPicture.loadPicture(
    ...
    // );
    final ui.Image image = await picture.toImage(key.pixelWidth, key.pixelHeight);
