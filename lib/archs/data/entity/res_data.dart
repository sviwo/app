...
class ResData<T> {
  ...
  ResData(
      {required this.code, required this.msg, this.data, this.originalData});
  ...
  factory ResData.fromJsonList(
      Map<String, dynamic> json, T Function(List<dynamic> json)? fromJsonT) {
...
ResData<T> _$ResDataFromJson3<T>(
  ...
  return ResData<T>(
    ...
    data: json['data'] == null
        ? null
        : (fromJsonT == null ? json['data'] : fromJsonT(json['data'])),
  );
}
